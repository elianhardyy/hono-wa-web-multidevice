...
// src/frontend/components/top.tsx
var TopView = (props) => {
  return /* @__PURE__ */ jsxDEV2(Fragment, { children: [
    /* @__PURE__ */ jsxDEV2("h1", { children: "Hello Hono!" }),
    /* @__PURE__ */ jsxDEV2("ul", { children: props.messages.map((message) => {
      return /* @__PURE__ */ jsxDEV2("li", { children: [
        message,
        "!!"
      ] });
    }) })
...
var mount = () => {
  ...
  render(/* @__PURE__ */ jsxDEV2(TopView, { messages: data.messages }), root);
};
mount();
